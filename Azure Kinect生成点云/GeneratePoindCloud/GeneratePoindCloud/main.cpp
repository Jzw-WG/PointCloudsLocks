    ...
    std::string file_name)
{
    ...
    tranformation_helpers_write_point_cloud(point_cloud_image, transformed_color_image, file_name.c_str(),-1,2000,-1,2000,0.5,1);
    ...
    std::string file_name)
{
    ...
    tranformation_helpers_write_point_cloud(point_cloud_image, color_image, file_name.c_str(), -1, 2000, -1, 2000, 1, 1.5);
