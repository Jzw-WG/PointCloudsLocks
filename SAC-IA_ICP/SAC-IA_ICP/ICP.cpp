...
int showICPviewer(PointCloudT::Ptr cloud_in, PointCloudT::Ptr cloud_tar, int iterations) // 默认的ICP迭代次数
{
    // 申明点云将要使用的
    ...
    *cloud_tr = *cloud_tar;
    ...
    viewer.addPointCloud(cloud_tar, cloud_in_color_h, "cloud_in_v1", v1);//设置原始的点云都是显示为白色
